...
<div id = "container">
	...
	<div id = "home"><h1>Update Product</h1></div>
	<div id = "contain">
		<div id = "side1">
			<ul>
		...
		<tr><td>Enter Quantity</td><td><input type = "text" name = "txt3"></td></tr>
		<tr><td>Enter Cost Price</td><td><input type = "text" name = "txt4"></td></tr>
		<tr><td>Enter Status</td><td><input type = "text" name = "txt5"></td></tr>
		<tr><td><input type = "submit" name = "sub" value = "Update" onclick = "return abc()"></td></tr>
		</table>
		</form>
		</div>
	</div>
