...
<div id = "container">
	...
	<div id = "contain">
		...
		%>
		<center>
		<form name="f1" action="editproduct.jsp" method="post">
		<table>
		<tr><td>Product ID</td><td><input type="text" name="txt1" value="<%= rs.getString("pid") %>" readonly></td></tr>
		<tr><td>Enter Name</td><td><input type="text" name="txt2" value="<%= rs.getString("pname") %>"></td></tr>
		<tr><td>Enter Catagory</td><td><input type="text" name="txt3" value="<%= rs.getString("catagory") %>"></td></tr>
		<tr><td>Enter Quantity</td><td><input type="text" name="txt4" value="<%= rs.getInt("quantity") %>"></td></tr>
		<tr><td>Enter Cost Price</td><td><input type="text" name="txt5" value="<%= rs.getInt("costprice") %>"></td></tr>
		<tr><td>Enter Status</td><td><input type="text" name="txt6" value="<%= rs.getString("status") %>"></td></tr>
		...
		<%
			...
			{
				out.println("<center><h3>Product not found!</h3></center>");
			}
		}
		catch(Exception ae)
		{
			out.println("Error loading product: " + ae.getMessage());
		}
		finally
		{
