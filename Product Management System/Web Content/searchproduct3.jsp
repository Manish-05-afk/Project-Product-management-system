...
<div id = "container">
	...
	<div id = "contain">
		...
		<div id = "side2">
		<center>
		<form name = "f1" action = "searchproduct4.jsp" method = "post">
		<table>
		<tr><td>Enter Catagory</td><td><input type = "text" name = "txt1"></td></tr>
		<tr><td><input type = "submit" name = "sub" value = "Search" onclick = "return abc()"></td></tr>
		</table>
		</form>
		</center>
