...
<div id = "container">
	...
	<div id = "contain">
		...
		<center>
			...
			<table>
			<tr><td>Username / Email</td><td><input type = "text" name = "txt1"></td></tr>
			<tr><td>Enter Password</td><td><input type = "password" name = "txt2"></td></tr>
			<tr><td colspan="2" align="center"><input type = "submit" name = "sub" value = "Login" onclick = "return abc()"></td></tr>
			</table>
			</form>
